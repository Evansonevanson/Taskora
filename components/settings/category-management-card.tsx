  ...
  return (
    <Card className="border-stone-800 bg-stone-900/40">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2 lg:grid-cols-3">
            {categories.map((cat) => (
              <div
                key={cat.id}
                className="flex items-center justify-between gap-2 rounded-xl border border-stone-800 bg-stone-950/40 p-3 transition-colors hover:border-stone-700"
              >
                <div className="flex items-center gap-2">
                  <Badge
                    variant={
                ...
                {cat.isSystem ? (
                  ...
                  <button
                    ...
                    className="flex h-6 w-6 items-center justify-center rounded-md text-stone-500 transition-colors hover:bg-red-950/40 hover:text-red-400"
                  >
        ...
        <form
          onSubmit={handleAdd}
          className="space-y-4 rounded-xl border border-stone-800/80 bg-stone-900/60 p-4"
        >
          ...
          {error && (
            <div
              role="alert"
              className="flex items-center gap-2 rounded-lg border border-red-500/20 bg-red-950/30 p-2.5 text-xs text-red-400"
            >
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <div className="space-y-1.5">
              <Label className="text-xs text-stone-300">Badge Color</Label>
