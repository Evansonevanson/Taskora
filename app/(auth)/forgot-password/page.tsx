...
export const metadata: Metadata = {
  title: 'Forgot Password | Taskora',
  description: 'Request a password reset link for your Taskora account.',
};
      ...
      <div className="relative w-full max-w-[420px] space-y-6">
        ...
        <div className="flex flex-col items-center space-y-2 text-center">
          ...
          >
            ...
            <span className="text-xs text-stone-400">Account Recovery</span>
          </Link>
        ...
        <Card className="border-stone-800/80 bg-stone-900/70 shadow-2xl ring-1 ring-white/5 backdrop-blur-xl">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription className="text-xs text-stone-400">
              We will send recovery instructions to your verified address.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ForgotPasswordForm />
